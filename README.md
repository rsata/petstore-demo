...
```sh
npm install git+ssh://git@github.com:rsata/petstore-demo.git
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/rsata/petstore-demo/issues) with questions, bugs, or suggestions.
