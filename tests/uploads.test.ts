import fs from 'fs';
import type { ResponseLike } from 'petstore-demo/internal/to-file';
import { toFile } from 'petstore-demo/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('petstore-demo/core/uploads');
    await expect(
